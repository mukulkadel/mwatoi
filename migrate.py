...
asrc = sqlite3.connect("messages.decrypted.db")
asrc.text_factory = text_factory
isrc = sqlite3.connect("7c7fba66680ef796b916b067077cc246adacf01d.db")
    ...
    for message in messages:
        ...
        if media_type == I_MEDIA_TYPE_TEXT and message["payment_transaction_id"] != None and message["payment_transaction_id"] != 'UNSET':
            add_payment_transaction(
                out, asrc, message, chat_session["ZGROUPINFO"] != None)
